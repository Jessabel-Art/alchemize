...
require_once __DIR__ . '/repositories/report-repository.php';
...
require_once __DIR__ . '/repositories/external-integration-repository.php';
...
require_once __DIR__ . '/services/external-integration-service.php';
