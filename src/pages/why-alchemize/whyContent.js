export const whyContent = {
  en: {
    ...
    audiences: {
      ...
      principle: {
        label: "One principle",
        text: "Make complex responsibilities easier to understand and act on.",
      },
      business: {
  ...
  es: {
    ...
    audiences: {
      ...
      principle: {
        label: "Un principio",
        text: "Hacer que las responsabilidades complejas sean más fáciles de entender y atender.",
      },
      business: {
