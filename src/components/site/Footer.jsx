...
const socialLinks = [
  ...
  {
    name: "Threads",
    href: "https://www.threads.com/@getalchemize",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/alchemize-business-services/",
...
const socialLabels = {
  en: {
    Instagram: "Alchemize on Instagram",
    Threads: "Alchemize on Threads",
    LinkedIn: "Alchemize on LinkedIn",
  },
  es: {
    Instagram: "Alchemize en Instagram",
    Threads: "Alchemize en Threads",
    LinkedIn: "Alchemize en LinkedIn",
  },
};
          ...
          <div className="footer-social">
            {socialLinks.map(({ name, href, path }) => (
              <a
                ...
                aria-label={socialLabels[language][name]}
              >
